...
<style scoped>
.nx { height: 100%; min-height: 0; display: grid; grid-template-rows: auto 1fr auto; background: #0d1117; color: rgba(255, 255, 255, 0.92); }
.nx-head { display: flex; align-items: center; justify-content: space-between; gap: 1rem; padding: 0.9rem 1.25rem; border-bottom: 1px solid #21262d; }
...
.nx-clear { border: 1px solid #21262d; background: transparent; color: rgba(255, 255, 255, 0.7); border-radius: 8px; padding: 0.25rem 0.6rem; font-size: 0.74rem; cursor: pointer; }
...
.nx-chip { border: 1px solid #21262d; background: #010409; color: rgba(255, 255, 255, 0.8); border-radius: 10px; padding: 0.55rem 0.8rem; font-size: 0.82rem; cursor: pointer; text-align: left; } .nx-chip:hover { border-color: #c58af9; }
...
.nx-badge { font-size: 0.6rem; text-transform: uppercase; letter-spacing: 0.04em; color: #3fb950; background: rgba(63, 185, 80, 0.12); border: 1px solid rgba(63, 185, 80, 0.3); border-radius: 5px; padding: 0.05rem 0.4rem; }

.nx-prompt { display: flex; align-items: flex-end; gap: 0.6rem; padding: 0.85rem 1.1rem; border-top: 1px solid #21262d; background: #0b0f14; }
.nx-prompt-glyph { color: #c58af9; font-size: 1.05rem; padding-bottom: 0.4rem; }
.nx-prompt textarea { flex: 1; resize: none; min-height: 1.4rem; max-height: 160px; background: #010409; border: 1px solid #21262d; border-radius: 12px; color: #fff; font: inherit; font-size: 0.92rem; line-height: 1.5; padding: 0.55rem 0.8rem; outline: none; } .nx-prompt textarea:focus { border-color: #c58af9; }
