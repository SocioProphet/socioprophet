...
.ss-fbtn { border: 1px solid var(--line-2); background: transparent; color: rgba(255, 255, 255, 0.6); border-radius: 7px; padding: 0.25rem 0.6rem; font-size: 0.72rem; cursor: pointer; text-transform: capitalize; } .ss-fbtn.on { border-color: var(--accent); color: var(--accent); background: var(--accent-soft); }
.ss-fbtn.sent.pos.on { border-color: var(--up); color: var(--up); background: rgba(63, 185, 80, 0.12); } .ss-fbtn.sent.neg.on { border-color: var(--down); color: var(--down); background: rgba(248, 81, 73, 0.12); }
...
.ss-stream { min-height: 0; overflow-y: auto; border: 1px solid var(--line-2); border-radius: 12px; }
.ss-empty { padding: 1.5rem; color: rgba(255, 255, 255, 0.45); font-size: 0.85rem; }
.ss-sig { padding: 0.7rem 0.9rem; border-bottom: 1px solid var(--line); }
...
.ss-mention { font-size: 0.56rem; text-transform: uppercase; letter-spacing: 0.04em; color: rgba(255, 255, 255, 0.5); border: 1px solid var(--line-2); border-radius: 4px; padding: 0.03rem 0.28rem; }
.ss-sent { width: 8px; height: 8px; border-radius: 50%; } .ss-sent.pos { background: var(--up); } .ss-sent.neg { background: var(--down); } .ss-sent.neu { background: #8b949e; }
...
.ss-trend { min-height: 0; overflow-y: auto; border: 1px solid var(--line-2); border-radius: 12px; padding: 0.5rem; }
...
.ss-trend-row { width: 100%; display: flex; align-items: baseline; gap: 0.6rem; border: none; background: transparent; color: inherit; padding: 0.4rem 0.5rem; border-radius: 8px; cursor: pointer; text-align: left; } .ss-trend-row:hover { background: rgba(255, 255, 255, 0.04); } .ss-trend-row.on { background: var(--accent-soft); }
.ss-trend-topic { flex: 1; font-size: 0.8rem; color: var(--accent-2); } .ss-trend-vol { font-size: 0.68rem; color: rgba(255, 255, 255, 0.4); font-variant-numeric: tabular-nums; }
.ss-trend-chg { font-size: 0.72rem; font-variant-numeric: tabular-nums; width: 3.4rem; text-align: right; } .ss-trend-chg.up { color: var(--up); } .ss-trend-chg.down { color: var(--down); }
.ss-mood { margin-top: 0.75rem; border-top: 1px solid var(--line-2); padding: 0.7rem 0.5rem 0.3rem; }
...
.ss-mood-bar { display: flex; height: 8px; border-radius: 4px; overflow: hidden; background: rgba(255, 255, 255, 0.06); } .ss-mood-bar .pos { background: var(--up); } .ss-mood-bar .neu { background: #8b949e; } .ss-mood-bar .neg { background: var(--down); }
.ss-mood-legend { display: flex; justify-content: space-between; margin-top: 0.4rem; font-size: 0.66rem; } .ss-mood-legend .pos { color: var(--up); } .ss-mood-legend .neu { color: #8b949e; } .ss-mood-legend .neg { color: var(--down); }
</style>
