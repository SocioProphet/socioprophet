...
export const markets: Market[] = [
  ...
  },
  {
    ...
    specimens: 2,
    note: 'First-pass scan — 2 of 5 named rivals actually researched, not a full teardown. Arc is dead: The Browser Company halted active development in May 2025 ("too different, too little reward" per CEO Josh Miller) and pivoted the team to Dia, an enterprise-facing AI browser, after Atlassian\'s $610M acquisition closed Oct 21 2025. Perplexity\'s Comet launched July 2025 as a $200/mo Max-gated product, then went free across iOS/Android/Windows/Mac on March 18 2026, with Pro features held behind the existing $20/mo Perplexity Pro plan and a separate $5/mo Comet Plus publisher-content add-on. The abandonment thesis holds; Brave, Chrome and Edge Copilot are still unassessed.',
  },
  {
    id: 'health-twin',
