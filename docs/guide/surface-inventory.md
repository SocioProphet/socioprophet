...
> This file is generated from `config/surfaces.json`. Edit the JSON source, not this file.

| Surface | Landing page | Survey / intake | Docs | Status | Next action |
|---|---:|---:|---:|---|---|
| Academy | Yes | Yes | Yes | live | Polish and continue documentation. |
| Organizations | Yes | Yes | No | live | Upgrade to Academy-level first-class quality. |
| Documentation | No | No | Yes | live | Keep as the source of deeper system detail. |
| AI Platform | No | No | Yes | stub | Decide whether this needs a first-class landing page. |
| Developer | No | No | Yes | stub | Promote to docs-backed landing page first. |
| Cloud Suite | No | No | Yes | stub | Clarify managed-platform scope. |
| Live Builds | No | No | Yes | stub | Decide how much live operational visibility to expose. |
| Medical | No | No | Yes | stub | Likely gated inquiry later, not open survey first. |
| Law | No | No | Yes | stub | Likely gated inquiry later, not open survey first. |
| Wiki | No | No | Yes | stub | Content-first, not survey-first. |
...
- **Audiences:** learners, families, mentors, educators
- **Topics:** learning, family, mentorship, cybernetics, safeguarding
- **Normalized topics:** learning, education, capability, trust, safeguarding
...
- **Related sites:** https://socioprophet.com/documentation/products/academy,/ https://socioprophet.com/documentation/academy-safeguarding-and-minor-protection/
...
- **Status:** live
- **Homepage visible:** Yes
- **Audiences:** schools, nonprofits, public-sector, employers
- **Topics:** deployment, institutions, governance, public-interest, secure-training
- **Normalized topics:** deployment, institutions, governance, trust, capability
- **Investor lens:** deployment_compounding
- **Landing page:** `/organizations/`
- **Survey / intake:** `/organizations/`
...
- **Related sites:** https://socioprophet.com/documentation/surface-inventory,/ https://socioprophet.com/documentation/domain-surface/
...
- **Related sites:** https://socioprophet.com/documentation/, https://socioprophet.com/documentation/canonical-platform-direction/
...
- **Related sites:** https://socioprophet.com/documentation/products/ai/
...
- **Status:** stub
- **Homepage visible:** Yes
- **Audiences:** builders, integrators
...
- **Related sites:** https://socioprophet.com/documentation/products/dev/
...
- **Related sites:** https://socioprophet.com/documentation/products/cloud/
...
- **Status:** stub
- **Homepage visible:** Yes
- **Audiences:** builders, operators, partners
...
- **Related sites:** https://socioprophet.com/documentation/products/live/
...
- **Status:** stub
- **Homepage visible:** Yes
- **Audiences:** providers, institutions, families
...
- **Related sites:** https://socioprophet.com/documentation/products/medical/
...
- **Status:** stub
- **Homepage visible:** Yes
- **Audiences:** legal, policy, governance
...
- **Related sites:** https://socioprophet.com/documentation/products/law/
...
- **Related sites:** https://socioprophet.com/documentation/products/wiki/
...
- **Related sites:** https://socioprophet.com/documentation/products/blog/
...
- **Status:** stub
- **Homepage visible:** Yes
- **Audiences:** operators, partners, public
...
- **Related sites:** https://socioprophet.com/documentation/domain-surface/
...
- **Status:** stub
- **Homepage visible:** No
- **Audiences:** investors, governance
- **Topics:** governance, capital, platform-direction
- **Normalized topics:** capital, governance, value-creation, platform, trust
- **Investor lens:** economic_profit
...
- **Related surfaces:** documentation, organizations, digital-trust
- **Related sites:** /investor/, /map/, https://socioprophet.com/documentation/surface-inventory/
